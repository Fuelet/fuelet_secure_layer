...
class _SaveSensitiveDataScreenState extends State<SaveSensitiveDataScreen> {
  ...
  void initState() {
    ...
    _privateData = _privateSecureLayerLocator<IAccountsPrivateDataRepository>()
        .getAccountPrivateData(widget.accountAddress.bech32Address);
  }
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder(
        ...
        builder: (context, snapshot) {
          final seedPhrase = snapshot.data?.seedPhrase;
          final privateKey = snapshot.data?.privateKey;
                              ...
                              child: SensitiveDataWidget(
                                ...
                                child: isPrivateKey
                                    ? Container(
                                        ...
                                        child: Text(
                                          data,
                                          style: NFTTypography.body2SemiBold
                                              .copyWith(
                                            color:
